        ...
        <div class="about-image reveal-left">
          <div class="about-image-wrapper">
            <img src="me.jpg" alt="Profile Photo"
              onerror="this.src='https://via.placeholder.com/500x500/1a1a25/00f0ff?text=Photo'">
          </div>
            ...
            <div class="project-image">
              <?php if ($project['image']): ?>
                <img src="<?= e($project['image']) ?>" alt="<?= e($project['title']) ?>"
                  onerror="this.src='https://via.placeholder.com/800x500/1a1a25/00f0ff?text=Project'">
              <?php else: ?>
                <img src="https://via.placeholder.com/800x500/1a1a25/00f0ff?text=<?= urlencode($project['title']) ?>"
                  alt="<?= e($project['title']) ?>">
              <?php endif; ?>
        ...
        <div class="contact-form-wrapper reveal-right">
          ...
          <form class="contact-form" method="POST" action="#contact">
            ...
            <div class="form-group">
              ...
              <textarea name="message" class="form-textarea" placeholder="Tell me about your project..."
                required></textarea>
            </div>
