                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="site_title" name="site_title" value="<?= e($settings['site_title'] ?? '') ?>">
                        </div>
                        <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" id="hero_tagline" name="hero_tagline" value="<?= e($settings['hero_tagline'] ?? '') ?>" placeholder="e.g., Frontend Developer • Location">
                        </div>
                        <div class="form-group">
                            <label for="hero_title">Main Heading</label>
                            <input type="text" id="hero_title" name="hero_title" value="<?= e($settings['hero_title'] ?? '') ?>" placeholder="e.g., Hi, I'm Zenith Kandel.">
                        </div>
                        <div class="form-group">
                            <label for="hero_subtitle">Subtitle / Description</label>
                            <textarea id="hero_subtitle" name="hero_subtitle" rows="3"><?= e($settings['hero_subtitle'] ?? '') ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea id="about_text" name="about_text" rows="4"><?= e($settings['about_text'] ?? '') ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="about_text_2">About Text (Paragraph 2) - Optional</label>
                            <textarea id="about_text_2" name="about_text_2" rows="4"><?= e($settings['about_text_2'] ?? '') ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="photo_url">Photo Filename</label>
                            <input type="text" id="photo_url" name="photo_url" value="<?= e($settings['photo_url'] ?? 'me.jpg') ?>">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" id="github_url" name="github_url" value="<?= e($settings['github_url'] ?? '') ?>">
                        </div>
                        <div class="form-group">
