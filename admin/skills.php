                ...
                <div class="card-body" style="padding: 0;">
                    <table class="table">
                        ...
                        <tbody>
                            <?php if (empty($skills)): ?>
                                <tr>
                                    <td colspan="4" style="text-align: center; padding: 40px; color: var(--text-muted);">No
                                        skills yet. Click "Add Skill" to create one.</td>
                                </tr>
                            <?php else: ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 12px;">
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-code</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-paintbrush</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-brands fa-js</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-brands fa-node-js</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-brands fa-react</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-brands fa-python</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-database</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-server</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-mobile-screen</code>
                        <code
                            style="background: #f5f5f5; padding: 6px 10px; border-radius: 4px; font-size: 13px;">fa-solid fa-pen-ruler</code>
                    </div>
                    <p style="color: var(--text-muted); font-size: 13px; margin-top: 12px;">Browse more at <a
                            href="https://fontawesome.com/icons" target="_blank">fontawesome.com/icons</a></p>
                </div>
            </div>
        </main>
    </div>
